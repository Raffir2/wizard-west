...
6. Opens rescue wagons, ranked by value per second. Red (Imperial) chests are a flat $1500, brown ones average $659.
7. Bandit camps: sticks to one camp until it's cleared, uses silent aim plus spells, and vacuums money drops map-wide.
